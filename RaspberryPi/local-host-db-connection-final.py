# Passing data to local db - label, confidence, distance, bin status, image, timestamp
...
try:
    while True:
        ...
        try:
            api_url = "http://192.168.8.123:5000/upload-data"  # Replace with your actual PC IP
